...
public class MecanumDrivingSample extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        MecanumDrive drive = new MecanumDrive(
                new Motor(hardwareMap, "frontL", Motor.GoBILDA.RPM_312),
                new Motor(hardwareMap, "frontR",  Motor.GoBILDA.RPM_312),
                new Motor(hardwareMap, "backL",  Motor.GoBILDA.RPM_312),
                new Motor(hardwareMap, "backR",  Motor.GoBILDA.RPM_312)
        );
